    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 relative overflow-hidden text-white">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-40 right-1/3 w-28 h-28 bg-pink-400 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-1 h-1 bg-pink-300 rounded-full animate-ping"></div>
        </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-green-500/25 flex items-center gap-2"
              >
       ...
       <WhatsAppOptInModal 
         ...
         onSuccess={(data) => {
           console.log('WhatsApp opt-in successful:', data);
